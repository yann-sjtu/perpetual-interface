...
import type { PerpetualV1, PerpetualV1Interface } from "../PerpetualV1";
...
export class PerpetualV1__factory {
  static readonly abi = _abi;
  static createInterface(): PerpetualV1Interface {
    return new utils.Interface(_abi) as PerpetualV1Interface;
  }
  static connect(
    address: string,
